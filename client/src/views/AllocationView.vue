        ...
        <div class="mt-6 p-4 bg-blue-50 rounded-lg border border-blue-200">
          <div class="flex items-start">
            ...
            <div>
              ...
              <p class="text-xs text-blue-700 mt-1">Target allocations will be automatically constrained within these policy limits. Default values are used for preset allocation strategies and rebalancing targets.</p>
            </div>
          </div>
        </div>
      </div>
