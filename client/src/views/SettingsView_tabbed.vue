        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-1">
          <nav class="flex space-x-1 overflow-x-auto" aria-label="Tabs">
            <button
              ...
              :class="[
                'flex-shrink-0 flex items-center justify-center px-4 py-2 text-sm font-medium rounded-md transition-colors whitespace-nowrap',
                activeTab === tab.id
              ...
              <div class="space-y-4">
                <div>
                  ...
                  <select v-model="(sim.options.spendingPolicy as any).type" class="input-field w-full p-3 rounded-md border-gray-300">
                    <option value="simple">Current Market Value</option>
                    <option value="avgMV3">Rolling 3-Year Average</option>
                    <option value="avgMV5">Rolling 5-Year Average</option>
                  </select>
                  <p class="text-xs text-gray-500 mt-1">
                    <strong>Current:</strong> Uses current year market value • 
                    <strong>Rolling Average:</strong> Smooths spending based on historical values
                  </p>
                </div>
                  ...
                  <div class="bg-orange-50 rounded-lg p-4 space-y-3">
                    <div class="flex items-center">
                      ...
                      <div>
                        ...
                        <p class="text-xs text-gray-600">Track inflation-adjusted benchmark (disabled by default)</p>
                      </div>
                    </div>
